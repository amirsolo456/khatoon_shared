...
class LatLngNullableConverter implements JsonConverter<LatLng?, Map<String, dynamic>?> {
...
class MembershipLevelConverter implements JsonConverter<MembershipLevel, String> {
